...
"SELECT PONumber FROM PO WHERE PONumber = SCOPE_IDENTITY()", sqlConn)
        ...
        sqlCmd.Parameters.Add("@DeliveryDate", SqlDbType.DateTime).Value = ConvertStringToDate(DeliveryDate.Text)
        ...
        sqlCmd.Parameters.Add("@DueDate", SqlDbType.DateTime).Value = ConvertStringToDate(DueDate.Text)
        sqlCmd.Parameters.Add("@GoodsArrivedDate", SqlDbType.DateTime).Value = ConvertStringToDate(GoodsArrivedDate.Text)
        sqlCmd.Parameters.Add("@LotNumber", SqlDbType.VarChar).Value = ConvertEmptyStringToNull(LotNumber.Text)
        sqlCmd.Parameters.Add("@InvoiceReceivedDate", SqlDbType.DateTime).Value = ConvertStringToDate(InvoceReceivedDate.Text)
        sqlCmd.Parameters.Add("@ImportCustomClearanceDate", SqlDbType.DateTime).Value = ConvertStringToDate(ImportCustomClearanceDate.Text)
        sqlCmd.Parameters.Add("@QMStartingDate", SqlDbType.DateTime).Value = ConvertStringToDate(QMStartingDate.Text)
        sqlCmd.Parameters.Add("@QMFinishDate", SqlDbType.DateTime).Value = ConvertStringToDate(QMFinishDate.Text)
        ...
        sqlCmd.Parameters.Add("@ScheduledExportDate", SqlDbType.DateTime).Value = ConvertStringToDate(ScheduledExportDate.Text)
