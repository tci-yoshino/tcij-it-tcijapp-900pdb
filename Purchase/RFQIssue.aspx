			        ...
			        <%  If bol_Parameter = True Then%>
    				    ...
    				    <table class="left">
	    				    <tr>
			    			    ...
			    			    <td>
                                    <asp:DropDownList ID="EnqLocation" runat="server" AutoPostBack="True" 
                                        DataSourceID="SDS_RFQIssue_Loc" DataTextField="Name" DataValueField="LocationCode">
                                        <asp:ListItem></asp:ListItem>
                                    </asp:DropDownList>
						            <asp:SqlDataSource ID="SDS_RFQIssue_Loc" runat="server" 
                                        ConnectionString="<%$ ConnectionStrings:DatabaseConnect %>" SelectCommand="SELECT LocationCode, Name FROM s_Location ORDER BY Name">
                                    </asp:SqlDataSource>
						        </td>
					        </tr>
    					    <tr>
		    				    ...
		    				    <td>
	    					        ...
	    					        <asp:SqlDataSource ID="SDS_RFQIssue_Enq_U" runat="server" 
                                        ...
                                        <SelectParameters>
                                            <asp:ControlParameter ControlID="EnqLocation" Name="LocationCode" PropertyName="SelectedValue" Type="String" />
    					    ...
    					    <tr>
		    				    ...
		    				    <td>
			    			        <asp:TextBox ID="ProductNumber" runat="server" Width="7em" MaxLength="12" AutoPostBack="true"></asp:TextBox> 
                            ...
                            <tr>
                                <th>CAS Number : </th>
                                <td>
                                    <asp:TextBox ID="CASNumber" runat="server" ReadOnly="True" CssClass="readonly" EnableViewState="False" ></asp:TextBox>
                                </td>
                            </tr>
					        <tr>
						        <th>Product Name : </th>
						        <td>
                                    <asp:TextBox ID="ProductName" runat="server" Width="21em" ReadOnly="True" CssClass="readonly" EnableViewState="False"></asp:TextBox>
						        </td>
					        </tr>
					        <tr>
						        <th>Supplier Code <span class="required">*</span> : </th>
						        <td>
						            <asp:TextBox ID="SupplierCode" runat="server" Width="7em" MaxLength="10" AutoPostBack="true" ></asp:TextBox>
						            <asp:ImageButton ID="SupplierSelect" runat="server" 
                                        ImageUrl="./Image/Search.gif" CssClass="magnify" OnClientClick="return SupplierSelect_onclick()" />
						        </td>
					        </tr>
					        <tr>
						        <th>SAP Supplier Code : </th>
						        <td>
                                    <asp:TextBox ID="R3SupplierCode" runat="server" Width="7em" MaxLength="10" 
                                        ReadOnly="true" CssClass="readonly" EnableViewState="False"></asp:TextBox>
						        </td>
					        </tr>
					        <tr>
					        ...
					        <tr>
						        <th>Maker Code : </th>
						        <td>
						            <asp:TextBox ID="MakerCode" runat="server" Width="7em" MaxLength="10" AutoPostBack="true" ></asp:TextBox>
						            <asp:ImageButton ID="MakerSelect" runat="server" 
                                        ImageUrl="./Image/Search.gif" CssClass="magnify" OnClientClick="return MakerSelect_onclick()" />
						        </td>
					        </tr>
                             <tr>
				        ...
				        <table>
					        ...
					        <tr>
						        ...
						        <td>
						            ...
						            <asp:SqlDataSource ID="SDS_RFQIssue_Que_U" runat="server" 
                                        ...
                                        SelectCommand="SELECT [UserID], [Name] FROM [v_User] WHERE (([LocationCode] = @LocationCode) AND ([isDisabled] = @isDisabled)) ORDER BY [Name]">
                                        <SelectParameters>
                                            <asp:ControlParameter ControlID="QuoLocation" Name="LocationCode" PropertyName="SelectedValue" Type="String" />
                                            <asp:Parameter DefaultValue="False" Name="isDisabled" Type="Boolean" />
                                        </SelectParameters>
                                    </asp:SqlDataSource>
						        </td>
					        ...
					        <tr>
						        ...
						        <td>
                                    <asp:DropDownList ID="Purpose" runat="server" 
                                        DataSourceID="SDS_RFQIssue_Pur" DataTextField="Text" DataValueField="PurposeCode">
                                        <asp:ListItem></asp:ListItem>
                                    </asp:DropDownList>
					        ...
					        <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="RequiredPurity" runat="server" Width="10em" MaxLength="255"></asp:TextBox>
                                </td>
					        </tr>
					        <tr>
						        <th>Required QM Method : </th>
                                <td>
                                    <asp:TextBox ID="RequiredQMMethod" runat="server" Width="10em" MaxLength="255"></asp:TextBox>
                                </td>
					        </tr>
					        <tr>
						        <th>Required Specification : </th>
                                <td>
                                    <asp:TextBox ID="RequiredSpecification" runat="server" Width="10em" MaxLength="255"></asp:TextBox>
                                </td>
					        </tr>
					        <tr>
						        <th>Comment : </th>
						        ...
						        <td>
                                    <asp:TextBox ID="Comment" runat="server" Columns="50" Rows="3" TextMode="MultiLine"></asp:TextBox>
						        </td>
					        </tr>
                            <tr>
    			        ...
    			        <div class="list">
                            <table style="width:50%">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox ID="SupplierItemNumber_1" runat="server" Width="10em" MaxLength="128"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <th>2</th>
                                    ...
                                    <td>
                                        <asp:TextBox ID="SupplierItemNumber_2" runat="server" Width="10em" MaxLength="128"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <th>3</th>
                                    ...
                                    <td>
                                        <asp:TextBox ID="SupplierItemNumber_3" runat="server" Width="10em" MaxLength="128"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <th>4</th>
                                    ...
                                    <td>
                                        <asp:TextBox ID="SupplierItemNumber_4" runat="server" Width="10em" MaxLength="128"></asp:TextBox>
                                    </td>
                                </tr>
                            </table>
				        </div>
				        ...
				        <div class="btns">
                            <asp:Button ID="Issue" runat="server" Text="Issue" OnClientClick="setAction('Issue');" />
				        </div>
