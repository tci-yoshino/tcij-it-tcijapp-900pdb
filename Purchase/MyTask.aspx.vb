...
Partial Public Class MyTask
    ...
    Private Function CreatePOSelectSQL() As String
        ...
        sb_SQL.Append("  CASE WHEN P.Priority IS NULL THEN ")
        sb_SQL.Append("                               CASE WHEN P.ParPriority IS NULL THEN '' ")
        sb_SQL.Append("                                    WHEN P.ParPriority IS NOT NULL THEN P.ParPriority END ")
        sb_SQL.Append("       WHEN P.Priority IS NOT NULL THEN P.Priority ")
        sb_SQL.Append("  END AS Priority, ")
