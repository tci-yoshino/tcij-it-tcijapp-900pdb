...
#Region "Page"
    ...
    Protected Class PageInfo
        ...
        Public Sub New()
            ...
            Me.pageList.Add(New PageItem With {.MainMenuName = "Setting", .PageName = "CountrySetting"})
            ...
            Me.pageList.Add(New PageItem With {.MainMenuName = "", .PageName = "POCorrespondence"})
            Me.pageList.Add(New PageItem With {.MainMenuName = "", .PageName = "POIssue"})
            Me.pageList.Add(New PageItem With {.MainMenuName = "RFQ Search", .PageName = "POListByRFQ"})
            Me.pageList.Add(New PageItem With {.MainMenuName = "", .PageName = "POStatus"})
            Me.pageList.Add(New PageItem With {.MainMenuName = "RFQ Search", .PageName = "POUpdate"})
            Me.pageList.Add(New PageItem With {.MainMenuName = "Setting", .PageName = "ProductListBySupplier"})
            ...
            Me.pageList.Add(New PageItem With {.MainMenuName = "Setting", .PageName = "ProductSetting"})
            Me.pageList.Add(New PageItem With {.MainMenuName = "", .PageName = "PurchaseGroup"})
            Me.pageList.Add(New PageItem With {.MainMenuName = "Setting", .PageName = "PurchaseGroupSetting"})
            ...
            Me.pageList.Add(New PageItem With {.MainMenuName = "Setting", .PageName = "SupplierListByProduct"})
            Me.pageList.Add(New PageItem With {.MainMenuName = "", .PageName = "SupplierSelect"})
            Me.pageList.Add(New PageItem With {.MainMenuName = "Setting", .PageName = "SupplierSetting"})
            Me.pageList.Add(New PageItem With {.MainMenuName = "", .PageName = "SuppliersProductImport"})
            Me.pageList.Add(New PageItem With {.MainMenuName = "Setting", .PageName = "SuppliersProductSetting"})
